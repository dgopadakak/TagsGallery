...
Политика конфиденциальности приложения TagsGallery.
Русская и английская версии равнозначны.

[Русский](#политика-конфиденциальности) · [English](#privacy-policy)
...
Приложение не передаёт ваши данные разработчику или третьим лицам. В нём нет:
...
**Кнопка «Поделиться».** При полноэкранном просмотре медиафайла доступна кнопка «Поделиться». По вашему явному действию приложение передаёт выбранный файл в другое приложение, которое вы сами указываете в системном диалоге выбора. Это происходит только по вашей инициативе; дальнейшее обращение с файлом регулируется политикой конфиденциальности приложения-получателя. Разработчик TagsGallery в этой передаче не участвует и никаких данных не получает.

**Ссылка на GitHub.** На экране тегов есть ссылка на страницу исходного кода проекта. При нажатии она открывается во внешнем браузере. Никакие ваши данные при этом не передаются.
...
The app transmits none of your data to the developer or to any third party. It contains no:
...
**The share button.** A share button is available while viewing a media file full-screen. On your explicit action, the app hands the selected file to another app that you choose yourself in the system chooser. This happens only at your initiative; what becomes of the file afterwards is governed by the receiving app's privacy policy. The developer of TagsGallery takes no part in this transfer and receives no data from it.

**The GitHub link.** The tags screen carries a link to the project's source code page. Tapping it opens your external browser. No data about you is transmitted.
